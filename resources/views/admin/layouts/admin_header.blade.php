                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{asset('public/admin')}}/dist/img/user2-160x160.jpg" class="img-circle" >
                                        </div>
                                        <h4>
                                            Support Team
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        {{--document.getElementById('logout-form').submit();">--}}
                                    ...
                                    <a href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();" class="btn btn-default btn-flat">{{ __('Logout') }}
                                    </a>
